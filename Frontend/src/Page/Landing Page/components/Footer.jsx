...
const Footer=()=>{
    ...
    return(
        <div class="bg-black w-full h-auto">
            <div class={`p-10 gap-5 flex justify-center ${isSmallDevice ? "flex-col":"flex-row  items-center"}  w-[100vw] `}>
                <div className={`${isSmallDevice ? "w-[100%]}":"w-[30%]"}`}>
                    <div className="flex">
                        <img src={Icon} className={`${isSmallDevice ? "w-[20%]":"w-[30%]"}`}/>
                    </div>
                    <h1 class={`text-white mt-5 ${isSmallDevice ? "text-[1rem]":"text-[1.3rem]"}`}>
            ...
            <ul class="p-10 flex justify-center gap-10 text-gray-400 border-t-gray-400 border-t-2">
                <li>
                    Site Map
                </li>
                <li>
